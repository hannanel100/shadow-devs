...
const LeadingMentors = async () => {
  // mock data for the 6 leading mentors, avatar, name, description, tags, location and rating
  // const leadingMentors: Mentor[] = [
  //   {
  //     avatar: "https://avatars.githubusercontent.com/u/1223799?v=4",
  //     name: "Sara Vieira",
  //     description:
  //       "Sara is a full stack developer, speaker and teacher. She's worked on a lot of cool projects like react-easy-state, react-spring, react-kawaii, react-particles-js, react-joyride and many more. She's currently working at Formidable, a consultancy specializing in React and React Native.",
  ...
  //     name: "Kent C. Dodds",
  //     description:
  //       "Kent is a full stack developer, speaker and teacher. He's worked on a lot of cool projects like react-easy-state, react-spring, react-kawaii, react-particles-js, react-joyride and many more. He's currently working at Formidable, a consultancy specializing in React and React Native.",
  //     tags: ["react", "javascript", "typescript", "nodejs"],
  //     location: "Berlin, Germany",
  //     rating: 4.9,
  //   },
